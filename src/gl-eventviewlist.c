...
{
    /* Add range filters */
    switch (journal_timestamp_range)
    {
...
create_query_object (GlEventViewList *view)
{
    ...
    query_add_journal_range_filter (query, view, priv->journal_timestamp_range, priv->boot_match);
...
set_up_search_popover (GlEventViewList *view)
{
    ...
    g_signal_connect (search_popover, "notify::journal-timestamp-range",
