...
void gl_journal_set_journal_start_position (GlJournal *journal, guint64 until_timestamp);
gboolean gl_journal_entry_check_journal_end (GlJournalEntry *entry, guint64 since_timestamp);
