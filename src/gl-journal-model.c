...
static void
gl_journal_model_process_query (GlJournalModel *model, gboolean exact_search)
{
                             ...
                             GlQuery *query)
{
    ...
    gl_journal_model_process_query (model, query->exact_search);
}
