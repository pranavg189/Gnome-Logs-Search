...
enum
{
    ...
    COLUMN_JOURNAL_TIMESTAMP_RANGE_ENUM_NAME,
                             ...
                             gpointer user_data)
{
    ...
    while (valid)
    {
        gchar *journal_range_enum_name;

        gtk_tree_model_get (GTK_TREE_MODEL (priv->range_liststore), &iter,
                            COLUMN_JOURNAL_TIMESTAMP_RANGE_ENUM_NAME, &journal_range_enum_name,
                            -1);

        if (g_strcmp0 (evalue->value_name, journal_range_enum_name) == 0)
        {
            g_free (journal_range_enum_name);
            break;
        }
                                 ...
                                 gpointer user_data)
{
    ...
    else if (strstr ("GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_PREVIOUS_BOOT", journal_range_enum_name))
    {
        evalue = g_enum_get_value (eclass, GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_PREVIOUS_BOOT);
    }
    else if (strstr ("GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_TODAY", journal_range_enum_name))
    {
        evalue = g_enum_get_value (eclass, GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_TODAY);
    }
    else if (strstr ("GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_YESTERDAY", journal_range_enum_name))
    {
        evalue = g_enum_get_value (eclass, GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_YESTERDAY);
    }
    else if (strstr ("GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_LAST_3_DAYS", journal_range_enum_name))
    {
        evalue = g_enum_get_value (eclass, GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_LAST_3_DAYS);
    }
    else if (strstr ("GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_ENTIRE_JOURNAL", journal_range_enum_name))
    {
        evalue = g_enum_get_value (eclass, GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_ENTIRE_JOURNAL);
    }
    else
    {
        evalue = g_enum_get_value (eclass, GL_SEARCH_POPOVER_JOURNAL_TIMESTAMP_RANGE_CUSTOM);
    }
                                  ...
                                  gpointer user_data)
{
    ...
    {
        button_label = g_date_time_format (start_date_time, "%T");
    }
